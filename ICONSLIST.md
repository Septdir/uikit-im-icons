...
2 | ![ie](icons/ie.svg) | ie | `uk-icon="icon: im-ie"`
3 | ![icomoon](icons/icomoon.svg) | icomoon | `uk-icon="icon: im-icomoon"`
4 | ![accessibility](icons/accessibility.svg) | accessibility | `uk-icon="icon: im-accessibility"`
5 | ![address-book](icons/address-book.svg) | address-book | `uk-icon="icon: im-address-book"`
6 | ![aid-kit](icons/aid-kit.svg) | aid-kit | `uk-icon="icon: im-aid-kit"`
7 | ![airplane](icons/airplane.svg) | airplane | `uk-icon="icon: im-airplane"`
8 | ![alarm](icons/alarm.svg) | alarm | `uk-icon="icon: im-alarm"`
9 | ![amazon](icons/amazon.svg) | amazon | `uk-icon="icon: im-amazon"`
10 | ![android](icons/android.svg) | android | `uk-icon="icon: im-android"`
11 | ![angry](icons/angry.svg) | angry | `uk-icon="icon: im-angry"`
12 | ![angry2](icons/angry2.svg) | angry2 | `uk-icon="icon: im-angry2"`
13 | ![appleinc](icons/appleinc.svg) | appleinc | `uk-icon="icon: im-appleinc"`
14 | ![arrow-down-left](icons/arrow-down-left.svg) | arrow-down-left | `uk-icon="icon: im-arrow-down-left"`
15 | ![arrow-down-left2](icons/arrow-down-left2.svg) | arrow-down-left2 | `uk-icon="icon: im-arrow-down-left2"`
16 | ![arrow-down-right](icons/arrow-down-right.svg) | arrow-down-right | `uk-icon="icon: im-arrow-down-right"`
17 | ![arrow-down-right2](icons/arrow-down-right2.svg) | arrow-down-right2 | `uk-icon="icon: im-arrow-down-right2"`
18 | ![arrow-down](icons/arrow-down.svg) | arrow-down | `uk-icon="icon: im-arrow-down"`
19 | ![arrow-down2](icons/arrow-down2.svg) | arrow-down2 | `uk-icon="icon: im-arrow-down2"`
20 | ![arrow-left](icons/arrow-left.svg) | arrow-left | `uk-icon="icon: im-arrow-left"`
21 | ![arrow-left2](icons/arrow-left2.svg) | arrow-left2 | `uk-icon="icon: im-arrow-left2"`
22 | ![arrow-right](icons/arrow-right.svg) | arrow-right | `uk-icon="icon: im-arrow-right"`
23 | ![arrow-right2](icons/arrow-right2.svg) | arrow-right2 | `uk-icon="icon: im-arrow-right2"`
24 | ![arrow-up-left](icons/arrow-up-left.svg) | arrow-up-left | `uk-icon="icon: im-arrow-up-left"`
25 | ![arrow-up-left2](icons/arrow-up-left2.svg) | arrow-up-left2 | `uk-icon="icon: im-arrow-up-left2"`
26 | ![arrow-up-right](icons/arrow-up-right.svg) | arrow-up-right | `uk-icon="icon: im-arrow-up-right"`
27 | ![arrow-up-right2](icons/arrow-up-right2.svg) | arrow-up-right2 | `uk-icon="icon: im-arrow-up-right2"`
28 | ![arrow-up](icons/arrow-up.svg) | arrow-up | `uk-icon="icon: im-arrow-up"`
29 | ![arrow-up2](icons/arrow-up2.svg) | arrow-up2 | `uk-icon="icon: im-arrow-up2"`
30 | ![attachment](icons/attachment.svg) | attachment | `uk-icon="icon: im-attachment"`
31 | ![backward](icons/backward.svg) | backward | `uk-icon="icon: im-backward"`
32 | ![backward2](icons/backward2.svg) | backward2 | `uk-icon="icon: im-backward2"`
33 | ![baffled](icons/baffled.svg) | baffled | `uk-icon="icon: im-baffled"`
34 | ![baffled2](icons/baffled2.svg) | baffled2 | `uk-icon="icon: im-baffled2"`
35 | ![barcode](icons/barcode.svg) | barcode | `uk-icon="icon: im-barcode"`
36 | ![basecamp](icons/basecamp.svg) | basecamp | `uk-icon="icon: im-basecamp"`
37 | ![behance](icons/behance.svg) | behance | `uk-icon="icon: im-behance"`
38 | ![behance2](icons/behance2.svg) | behance2 | `uk-icon="icon: im-behance2"`
39 | ![bell](icons/bell.svg) | bell | `uk-icon="icon: im-bell"`
40 | ![bin](icons/bin.svg) | bin | `uk-icon="icon: im-bin"`
41 | ![bin2](icons/bin2.svg) | bin2 | `uk-icon="icon: im-bin2"`
42 | ![binoculars](icons/binoculars.svg) | binoculars | `uk-icon="icon: im-binoculars"`
43 | ![blocked](icons/blocked.svg) | blocked | `uk-icon="icon: im-blocked"`
44 | ![blog](icons/blog.svg) | blog | `uk-icon="icon: im-blog"`
45 | ![blogger](icons/blogger.svg) | blogger | `uk-icon="icon: im-blogger"`
46 | ![blogger2](icons/blogger2.svg) | blogger2 | `uk-icon="icon: im-blogger2"`
47 | ![bold](icons/bold.svg) | bold | `uk-icon="icon: im-bold"`
48 | ![book](icons/book.svg) | book | `uk-icon="icon: im-book"`
49 | ![bookmark](icons/bookmark.svg) | bookmark | `uk-icon="icon: im-bookmark"`
50 | ![bookmarks](icons/bookmarks.svg) | bookmarks | `uk-icon="icon: im-bookmarks"`
51 | ![books](icons/books.svg) | books | `uk-icon="icon: im-books"`
52 | ![box-add](icons/box-add.svg) | box-add | `uk-icon="icon: im-box-add"`
53 | ![box-remove](icons/box-remove.svg) | box-remove | `uk-icon="icon: im-box-remove"`
54 | ![briefcase](icons/briefcase.svg) | briefcase | `uk-icon="icon: im-briefcase"`
55 | ![brightness-contrast](icons/brightness-contrast.svg) | brightness-contrast | `uk-icon="icon: im-brightness-contrast"`
56 | ![bubble](icons/bubble.svg) | bubble | `uk-icon="icon: im-bubble"`
57 | ![bubble2](icons/bubble2.svg) | bubble2 | `uk-icon="icon: im-bubble2"`
58 | ![bubbles](icons/bubbles.svg) | bubbles | `uk-icon="icon: im-bubbles"`
59 | ![bubbles2](icons/bubbles2.svg) | bubbles2 | `uk-icon="icon: im-bubbles2"`
60 | ![bubbles3](icons/bubbles3.svg) | bubbles3 | `uk-icon="icon: im-bubbles3"`
61 | ![bubbles4](icons/bubbles4.svg) | bubbles4 | `uk-icon="icon: im-bubbles4"`
62 | ![bug](icons/bug.svg) | bug | `uk-icon="icon: im-bug"`
63 | ![bullhorn](icons/bullhorn.svg) | bullhorn | `uk-icon="icon: im-bullhorn"`
64 | ![calculator](icons/calculator.svg) | calculator | `uk-icon="icon: im-calculator"`
65 | ![calendar](icons/calendar.svg) | calendar | `uk-icon="icon: im-calendar"`
66 | ![camera](icons/camera.svg) | camera | `uk-icon="icon: im-camera"`
67 | ![cancel-circle](icons/cancel-circle.svg) | cancel-circle | `uk-icon="icon: im-cancel-circle"`
68 | ![cart](icons/cart.svg) | cart | `uk-icon="icon: im-cart"`
69 | ![checkbox-checked](icons/checkbox-checked.svg) | checkbox-checked | `uk-icon="icon: im-checkbox-checked"`
70 | ![checkbox-unchecked](icons/checkbox-unchecked.svg) | checkbox-unchecked | `uk-icon="icon: im-checkbox-unchecked"`
71 | ![checkmark](icons/checkmark.svg) | checkmark | `uk-icon="icon: im-checkmark"`
72 | ![checkmark2](icons/checkmark2.svg) | checkmark2 | `uk-icon="icon: im-checkmark2"`
73 | ![chrome](icons/chrome.svg) | chrome | `uk-icon="icon: im-chrome"`
74 | ![circle-down](icons/circle-down.svg) | circle-down | `uk-icon="icon: im-circle-down"`
75 | ![circle-left](icons/circle-left.svg) | circle-left | `uk-icon="icon: im-circle-left"`
76 | ![circle-right](icons/circle-right.svg) | circle-right | `uk-icon="icon: im-circle-right"`
77 | ![circle-up](icons/circle-up.svg) | circle-up | `uk-icon="icon: im-circle-up"`
78 | ![clear-formatting](icons/clear-formatting.svg) | clear-formatting | `uk-icon="icon: im-clear-formatting"`
79 | ![clipboard](icons/clipboard.svg) | clipboard | `uk-icon="icon: im-clipboard"`
80 | ![clock](icons/clock.svg) | clock | `uk-icon="icon: im-clock"`
81 | ![clock2](icons/clock2.svg) | clock2 | `uk-icon="icon: im-clock2"`
82 | ![cloud-check](icons/cloud-check.svg) | cloud-check | `uk-icon="icon: im-cloud-check"`
83 | ![cloud-download](icons/cloud-download.svg) | cloud-download | `uk-icon="icon: im-cloud-download"`
84 | ![cloud-upload](icons/cloud-upload.svg) | cloud-upload | `uk-icon="icon: im-cloud-upload"`
85 | ![cloud](icons/cloud.svg) | cloud | `uk-icon="icon: im-cloud"`
86 | ![clubs](icons/clubs.svg) | clubs | `uk-icon="icon: im-clubs"`
87 | ![codepen](icons/codepen.svg) | codepen | `uk-icon="icon: im-codepen"`
88 | ![cog](icons/cog.svg) | cog | `uk-icon="icon: im-cog"`
89 | ![cogs](icons/cogs.svg) | cogs | `uk-icon="icon: im-cogs"`
90 | ![coin-dollar](icons/coin-dollar.svg) | coin-dollar | `uk-icon="icon: im-coin-dollar"`
91 | ![coin-euro](icons/coin-euro.svg) | coin-euro | `uk-icon="icon: im-coin-euro"`
92 | ![coin-pound](icons/coin-pound.svg) | coin-pound | `uk-icon="icon: im-coin-pound"`
93 | ![coin-yen](icons/coin-yen.svg) | coin-yen | `uk-icon="icon: im-coin-yen"`
94 | ![command](icons/command.svg) | command | `uk-icon="icon: im-command"`
95 | ![compass](icons/compass.svg) | compass | `uk-icon="icon: im-compass"`
96 | ![compass2](icons/compass2.svg) | compass2 | `uk-icon="icon: im-compass2"`
97 | ![confused](icons/confused.svg) | confused | `uk-icon="icon: im-confused"`
98 | ![confused2](icons/confused2.svg) | confused2 | `uk-icon="icon: im-confused2"`
99 | ![connection](icons/connection.svg) | connection | `uk-icon="icon: im-connection"`
100 | ![contrast](icons/contrast.svg) | contrast | `uk-icon="icon: im-contrast"`
101 | ![cool](icons/cool.svg) | cool | `uk-icon="icon: im-cool"`
102 | ![cool2](icons/cool2.svg) | cool2 | `uk-icon="icon: im-cool2"`
103 | ![copy](icons/copy.svg) | copy | `uk-icon="icon: im-copy"`
104 | ![credit-card](icons/credit-card.svg) | credit-card | `uk-icon="icon: im-credit-card"`
105 | ![crop](icons/crop.svg) | crop | `uk-icon="icon: im-crop"`
106 | ![cross](icons/cross.svg) | cross | `uk-icon="icon: im-cross"`
107 | ![crying](icons/crying.svg) | crying | `uk-icon="icon: im-crying"`
108 | ![crying2](icons/crying2.svg) | crying2 | `uk-icon="icon: im-crying2"`
109 | ![css3](icons/css3.svg) | css3 | `uk-icon="icon: im-css3"`
110 | ![ctrl](icons/ctrl.svg) | ctrl | `uk-icon="icon: im-ctrl"`
111 | ![database](icons/database.svg) | database | `uk-icon="icon: im-database"`
112 | ![delicious](icons/delicious.svg) | delicious | `uk-icon="icon: im-delicious"`
113 | ![deviantart](icons/deviantart.svg) | deviantart | `uk-icon="icon: im-deviantart"`
114 | ![diamonds](icons/diamonds.svg) | diamonds | `uk-icon="icon: im-diamonds"`
115 | ![dice](icons/dice.svg) | dice | `uk-icon="icon: im-dice"`
116 | ![display](icons/display.svg) | display | `uk-icon="icon: im-display"`
117 | ![download](icons/download.svg) | download | `uk-icon="icon: im-download"`
118 | ![download2](icons/download2.svg) | download2 | `uk-icon="icon: im-download2"`
119 | ![download3](icons/download3.svg) | download3 | `uk-icon="icon: im-download3"`
120 | ![drawer](icons/drawer.svg) | drawer | `uk-icon="icon: im-drawer"`
121 | ![drawer2](icons/drawer2.svg) | drawer2 | `uk-icon="icon: im-drawer2"`
122 | ![dribbble](icons/dribbble.svg) | dribbble | `uk-icon="icon: im-dribbble"`
123 | ![drive](icons/drive.svg) | drive | `uk-icon="icon: im-drive"`
124 | ![dropbox](icons/dropbox.svg) | dropbox | `uk-icon="icon: im-dropbox"`
125 | ![droplet](icons/droplet.svg) | droplet | `uk-icon="icon: im-droplet"`
126 | ![earth](icons/earth.svg) | earth | `uk-icon="icon: im-earth"`
127 | ![edge](icons/edge.svg) | edge | `uk-icon="icon: im-edge"`
128 | ![eject](icons/eject.svg) | eject | `uk-icon="icon: im-eject"`
129 | ![ello](icons/ello.svg) | ello | `uk-icon="icon: im-ello"`
130 | ![embed](icons/embed.svg) | embed | `uk-icon="icon: im-embed"`
131 | ![embed2](icons/embed2.svg) | embed2 | `uk-icon="icon: im-embed2"`
132 | ![enlarge](icons/enlarge.svg) | enlarge | `uk-icon="icon: im-enlarge"`
133 | ![enlarge2](icons/enlarge2.svg) | enlarge2 | `uk-icon="icon: im-enlarge2"`
134 | ![enter](icons/enter.svg) | enter | `uk-icon="icon: im-enter"`
135 | ![envelop](icons/envelop.svg) | envelop | `uk-icon="icon: im-envelop"`
136 | ![equalizer](icons/equalizer.svg) | equalizer | `uk-icon="icon: im-equalizer"`
137 | ![equalizer2](icons/equalizer2.svg) | equalizer2 | `uk-icon="icon: im-equalizer2"`
138 | ![evil](icons/evil.svg) | evil | `uk-icon="icon: im-evil"`
139 | ![evil2](icons/evil2.svg) | evil2 | `uk-icon="icon: im-evil2"`
140 | ![exit](icons/exit.svg) | exit | `uk-icon="icon: im-exit"`
141 | ![eye-blocked](icons/eye-blocked.svg) | eye-blocked | `uk-icon="icon: im-eye-blocked"`
142 | ![eye-minus](icons/eye-minus.svg) | eye-minus | `uk-icon="icon: im-eye-minus"`
143 | ![eye-plus](icons/eye-plus.svg) | eye-plus | `uk-icon="icon: im-eye-plus"`
144 | ![eye](icons/eye.svg) | eye | `uk-icon="icon: im-eye"`
145 | ![eyedropper](icons/eyedropper.svg) | eyedropper | `uk-icon="icon: im-eyedropper"`
146 | ![facebook](icons/facebook.svg) | facebook | `uk-icon="icon: im-facebook"`
147 | ![facebook2](icons/facebook2.svg) | facebook2 | `uk-icon="icon: im-facebook2"`
148 | ![feed](icons/feed.svg) | feed | `uk-icon="icon: im-feed"`
149 | ![file-empty](icons/file-empty.svg) | file-empty | `uk-icon="icon: im-file-empty"`
150 | ![file-excel](icons/file-excel.svg) | file-excel | `uk-icon="icon: im-file-excel"`
151 | ![file-music](icons/file-music.svg) | file-music | `uk-icon="icon: im-file-music"`
152 | ![file-openoffice](icons/file-openoffice.svg) | file-openoffice | `uk-icon="icon: im-file-openoffice"`
153 | ![file-pdf](icons/file-pdf.svg) | file-pdf | `uk-icon="icon: im-file-pdf"`
154 | ![file-picture](icons/file-picture.svg) | file-picture | `uk-icon="icon: im-file-picture"`
155 | ![file-play](icons/file-play.svg) | file-play | `uk-icon="icon: im-file-play"`
156 | ![file-text](icons/file-text.svg) | file-text | `uk-icon="icon: im-file-text"`
157 | ![file-text2](icons/file-text2.svg) | file-text2 | `uk-icon="icon: im-file-text2"`
158 | ![file-video](icons/file-video.svg) | file-video | `uk-icon="icon: im-file-video"`
159 | ![file-word](icons/file-word.svg) | file-word | `uk-icon="icon: im-file-word"`
160 | ![file-zip](icons/file-zip.svg) | file-zip | `uk-icon="icon: im-file-zip"`
161 | ![files-empty](icons/files-empty.svg) | files-empty | `uk-icon="icon: im-files-empty"`
162 | ![film](icons/film.svg) | film | `uk-icon="icon: im-film"`
163 | ![filter](icons/filter.svg) | filter | `uk-icon="icon: im-filter"`
164 | ![finder](icons/finder.svg) | finder | `uk-icon="icon: im-finder"`
165 | ![fire](icons/fire.svg) | fire | `uk-icon="icon: im-fire"`
166 | ![firefox](icons/firefox.svg) | firefox | `uk-icon="icon: im-firefox"`
167 | ![first](icons/first.svg) | first | `uk-icon="icon: im-first"`
168 | ![flag](icons/flag.svg) | flag | `uk-icon="icon: im-flag"`
169 | ![flattr](icons/flattr.svg) | flattr | `uk-icon="icon: im-flattr"`
170 | ![flickr](icons/flickr.svg) | flickr | `uk-icon="icon: im-flickr"`
171 | ![flickr2](icons/flickr2.svg) | flickr2 | `uk-icon="icon: im-flickr2"`
172 | ![flickr3](icons/flickr3.svg) | flickr3 | `uk-icon="icon: im-flickr3"`
173 | ![flickr4](icons/flickr4.svg) | flickr4 | `uk-icon="icon: im-flickr4"`
174 | ![floppy-disk](icons/floppy-disk.svg) | floppy-disk | `uk-icon="icon: im-floppy-disk"`
175 | ![folder-download](icons/folder-download.svg) | folder-download | `uk-icon="icon: im-folder-download"`
176 | ![folder-minus](icons/folder-minus.svg) | folder-minus | `uk-icon="icon: im-folder-minus"`
177 | ![folder-open](icons/folder-open.svg) | folder-open | `uk-icon="icon: im-folder-open"`
178 | ![folder-plus](icons/folder-plus.svg) | folder-plus | `uk-icon="icon: im-folder-plus"`
179 | ![folder-upload](icons/folder-upload.svg) | folder-upload | `uk-icon="icon: im-folder-upload"`
180 | ![folder](icons/folder.svg) | folder | `uk-icon="icon: im-folder"`
181 | ![font-size](icons/font-size.svg) | font-size | `uk-icon="icon: im-font-size"`
182 | ![font](icons/font.svg) | font | `uk-icon="icon: im-font"`
183 | ![forward](icons/forward.svg) | forward | `uk-icon="icon: im-forward"`
184 | ![forward2](icons/forward2.svg) | forward2 | `uk-icon="icon: im-forward2"`
185 | ![forward3](icons/forward3.svg) | forward3 | `uk-icon="icon: im-forward3"`
186 | ![foursquare](icons/foursquare.svg) | foursquare | `uk-icon="icon: im-foursquare"`
187 | ![frustrated](icons/frustrated.svg) | frustrated | `uk-icon="icon: im-frustrated"`
188 | ![frustrated2](icons/frustrated2.svg) | frustrated2 | `uk-icon="icon: im-frustrated2"`
189 | ![gift](icons/gift.svg) | gift | `uk-icon="icon: im-gift"`
190 | ![git](icons/git.svg) | git | `uk-icon="icon: im-git"`
191 | ![github](icons/github.svg) | github | `uk-icon="icon: im-github"`
192 | ![glass](icons/glass.svg) | glass | `uk-icon="icon: im-glass"`
193 | ![glass2](icons/glass2.svg) | glass2 | `uk-icon="icon: im-glass2"`
194 | ![google-drive](icons/google-drive.svg) | google-drive | `uk-icon="icon: im-google-drive"`
195 | ![google-plus](icons/google-plus.svg) | google-plus | `uk-icon="icon: im-google-plus"`
196 | ![google-plus2](icons/google-plus2.svg) | google-plus2 | `uk-icon="icon: im-google-plus2"`
197 | ![google-plus3](icons/google-plus3.svg) | google-plus3 | `uk-icon="icon: im-google-plus3"`
198 | ![google](icons/google.svg) | google | `uk-icon="icon: im-google"`
199 | ![google2](icons/google2.svg) | google2 | `uk-icon="icon: im-google2"`
200 | ![google3](icons/google3.svg) | google3 | `uk-icon="icon: im-google3"`
201 | ![grin](icons/grin.svg) | grin | `uk-icon="icon: im-grin"`
202 | ![grin2](icons/grin2.svg) | grin2 | `uk-icon="icon: im-grin2"`
203 | ![hackernews](icons/hackernews.svg) | hackernews | `uk-icon="icon: im-hackernews"`
204 | ![hammer](icons/hammer.svg) | hammer | `uk-icon="icon: im-hammer"`
205 | ![hammer2](icons/hammer2.svg) | hammer2 | `uk-icon="icon: im-hammer2"`
206 | ![hangouts](icons/hangouts.svg) | hangouts | `uk-icon="icon: im-hangouts"`
207 | ![happy](icons/happy.svg) | happy | `uk-icon="icon: im-happy"`
208 | ![happy2](icons/happy2.svg) | happy2 | `uk-icon="icon: im-happy2"`
209 | ![headphones](icons/headphones.svg) | headphones | `uk-icon="icon: im-headphones"`
210 | ![heart-broken](icons/heart-broken.svg) | heart-broken | `uk-icon="icon: im-heart-broken"`
211 | ![heart](icons/heart.svg) | heart | `uk-icon="icon: im-heart"`
212 | ![hipster](icons/hipster.svg) | hipster | `uk-icon="icon: im-hipster"`
213 | ![hipster2](icons/hipster2.svg) | hipster2 | `uk-icon="icon: im-hipster2"`
214 | ![history](icons/history.svg) | history | `uk-icon="icon: im-history"`
215 | ![home](icons/home.svg) | home | `uk-icon="icon: im-home"`
216 | ![home2](icons/home2.svg) | home2 | `uk-icon="icon: im-home2"`
217 | ![home3](icons/home3.svg) | home3 | `uk-icon="icon: im-home3"`
218 | ![hour-glass](icons/hour-glass.svg) | hour-glass | `uk-icon="icon: im-hour-glass"`
219 | ![html-five](icons/html-five.svg) | html-five | `uk-icon="icon: im-html-five"`
220 | ![html-five2](icons/html-five2.svg) | html-five2 | `uk-icon="icon: im-html-five2"`
